...
export interface FileRouteTypes {
  ...
  id: '__root__' | '/' | '/auth' | '/api/chat' | '/api/image' | '/c/$conversationId'
...
const rootRouteChildren: RootRouteChildren = { IndexRoute, AuthRoute, ApiChatRoute, ApiImageRoute, CConversationIdRoute }
